...
[Source: bmad-docs/specs/tech-spec-epic-2.md#Haiku-API-Client-Integration, lines 312-336]
...
- [Source: bmad-docs/specs/tech-spec-epic-2.md#Story-2.4-Acceptance-Criteria, lines 405-409] - AC-2.4.1 bis AC-2.4.4 (authoritative)
- [Source: bmad-docs/epics.md#Story-2.4, lines 634-668] - User Story Definition und Acceptance Criteria
- [Source: bmad-docs/specs/tech-spec-epic-2.md#Haiku-API-Client-Integration, lines 312-336] - HaikuClient Implementation Pattern
- [Source: bmad-docs/specs/tech-spec-epic-2.md#Reliability/Availability, lines 247-258] - Retry-Logic Specification
...
- `bmad-docs/planning/sprint-status.yaml` - Story status: ready-for-dev → in-progress → review
