...
Next Steps:
  ...
  3. Document results in: docs/7-day-stability-report.md
═══════════════════════════════════════════════════════════════
```
...
**Output:**
- Report saved to: `docs/7-day-stability-report.md`
...
1. Copy Template: `cp docs/7-day-stability-report-template.md docs/7-day-stability-report.md`
2. Open: `docs/7-day-stability-report.md`
...
```bash
cd /home/ethr/01-projects/ai-experiments/i-o
git add docs/7-day-stability-report.md
...
- **Option B:** Manual - Use `docs/7-day-stability-report-template.md` und fill in manually
...
| `docs/7-day-stability-report.md` | Final Stability Report |
| `docs/7-day-stability-report-template.md` | Template für manual report |
