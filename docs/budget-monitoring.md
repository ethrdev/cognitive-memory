...
Direct SQL queries for Claude Code integration (see `docs/budget-monitoring-sql-queries.md`):
...
- **SQL Queries**: `docs/budget-monitoring-sql-queries.md`
- **Architecture**: `bmad-docs/architecture.md`
- **Tech Spec**: `bmad-docs/tech-spec-epic-3.md`
